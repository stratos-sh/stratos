...
// kubernetesPodToNodePoolMapper returns a function that maps unschedulable pods to NodePools.
func kubernetesPodToNodePoolMapper(c client.Client) func(ctx context.Context, obj client.Object) []reconcile.Request {
...
func PodEventHandler(c client.Client) handler.EventHandler {
	return handler.EnqueueRequestsFromMapFunc(kubernetesPodToNodePoolMapper(c))
}
